  ...
  data() {
    return {
      ...
      options: {
        ...
        customBackend: {
          "DracoHosted": "https://subc.l1nk.lol",
      ...
      form: {
        sourceSubUrl: "",
        clientType: "",
        customBackend: this.getUrlParam() == "" ? "https://subc.l1nk.lol" : this.getUrlParam(),
    ...
    getBackendVersion() {
      this.$axios
          ...
          .then(res => {
            ...
            let a = this.form.customBackend.indexOf("subc.l1nk.lol") !== -1 || this.form.customBackend.indexOf("sub.d1.mk") !== -1;
